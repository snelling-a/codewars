...
A Narcissistic Number (https://en.wikipedia.org/wiki/Narcissistic_number) is a positive number
...
/**
 * @export
 * @param {number} value Positive non-zero integers
 * @returns {*} `true`: number is Narcissistic, `false`: number is not Narcissistic
 */
