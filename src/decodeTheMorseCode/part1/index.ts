...
In this kata you have to write a simple Morse code (https://en.wikipedia.org/wiki/Morse_code) decoder.
...
the most notorious of those is the international distress signal SOS (https://en.wikipedia.org/wiki/SOS) (that was first issued by Titanic (https://en.wikipedia.org/wiki/RMS_Titanic)),
